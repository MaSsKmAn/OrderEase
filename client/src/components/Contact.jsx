...
const Contact = () => {
  return (
    <div style={{width:"80vw"}}>
      ...
      <p>
        <div className="row" style={{ textAlign: "left", color:"inherit" }}>
          <div className="col-md-3" style={{ margin: "12px",color:"inherit", }}>
            <ul className="list-group">
              <li className="list-group-item">ABOUT ORDEREASE </li>
              ...
              <li className="list-group-item">Report Fraud</li>
            </ul>
          </div>
          <div className="col-md-3" style={{ margin: "12px" }}>
            <ul className="list-group">
              <li className="list-group-item">FOR RESTAURANTS </li>
          ...
          <div className="col-md-3" style={{ margin: "12px" }}>
            ...
            <div className="col-md-3" style={{ margin: "12px" }}>
              <ul className="list-group">
                <li className="list-group-item">SOCIAL LINKS</li>
